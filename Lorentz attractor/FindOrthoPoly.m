...
% ==================================================================
function [C_a_Psi, C_c_Psi, C_ab_Psi, C_bc_Psi, C_x_Psi, Psi, polys, decvars] = FindOrthoPoly(x,bx,deg_a,deg_c,order,type,opts)
...
% C_c_Psi = pinv(C_Psi_xmon'*C_Psi_xmon)*C_Psi_xmon'*C_c_xmon;
