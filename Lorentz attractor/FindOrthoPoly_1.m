...
% ==================================================================
function [C_s_Psi,C_a_Psi, C_c_Psi, C_ab_Psi, C_bc_Psi, C_x_Psi, Psi, polys, decvars, decvars_1] = FindOrthoPoly(x,bx,deg_a,deg_c,deg_s,order,type,opts)
...
[ixmon_Psi,iPsimon] = ismember(xmon.degmat, Psimon.degmat, 'rows');
...
[ixmon_x,ix] = ismember(xmon.degmat, x.degmat, 'rows');
...
decvars = [C_a_amon; C_c_cmon];
decvars_1 = [C_a_amon; C_c_cmon; C_s_smon];
disp('Coefficient vectors are found based on polynomial basis.');